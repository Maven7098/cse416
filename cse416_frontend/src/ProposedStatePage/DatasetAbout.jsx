  ...
  return (
    <div className="leaflet-containerset">
      <div className="leaflet-container-big">
        ...
        <p>256_High means...</p>
        <p><b>256</b>: Number of Ensembles generated. Can be...</p>
        <p style={{ margin: "2px" }}>256: 256 Ensembles generated (sample set)</p>
        <p style={{ margin: "2px" }}>or</p>
        <p>4096: 4096 Ensembles generated (production set)</p>
